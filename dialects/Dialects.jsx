            ...
            <div className="dialects">
                ...
                <div className="cards-container">
                    <div className="card">
                        ...
                        <div className="div-wrapper"><div className="button">Learn More</div></div>
                    </div>
                    ...
                    <div className="card">
                        <img className="img" src={ilocano_dialect} alt="Ilocano" />
                        <div className="card-title">Ilocano</div>
                        <p className="card-desc">
